...
describe("home advisor cash-flow signals", () => {
  it("prioritizes an early cash shortfall over a generic stable assessment", () => {
    ...
    const data: AppData = {
      ...
      wallets: [{ id: "wallet", name: "Ví chính", icon: "Wallet", color: "#000", initialBalance: 100_000, archived: false, createdAt: "", updatedAt: "" }],
      ...
      transactions: [], budgets: [], occurrences: [], debts: [], payments: [], goals: [], goalEntries: [], installments: [],
      rules: [
